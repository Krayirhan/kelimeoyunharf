...
//   image     kapak görseli, assets/covers/ altında kare webp (varsa cover yerine gösterilir)
...
window.OYUN_ARASI_GAMES = [
  ...
  { id: 'sudoku', tagline: 'Sayı bulmacası', href: 'games/sudoku/', title: 'Sudoku', cover: { name: 'sudoku', color: '#f7802f', label: 'SUDOKU', cells: ['5', '3', '', '6', '', '9', '', '8', '1'], tones: ['', '', '', '', 'y', '', '', '', ''] }, category: 'logic number', search: 'sayı' },
  { id: 'sekil', tagline: 'Parçaları yerleştir', href: 'games/sekil/', title: 'Şekil Birleştir', cover: { name: 'sekil', color: '#ff7fa8', label: 'ŞEKİL<br>BİRLEŞTİR', cells: ['', '', '', '', '', '', '', '', ''], tones: ['o', 'o', 'n', 'o', 'g', 'g', 'b', 'b', 'g'] }, category: 'logic', search: 'blok' },
  { id: 'kelime-avi', tagline: 'Harflerden kelime', href: 'games/kelime-avi/', title: 'Kelime Avı', cover: { name: 'kelime', color: '#c2185b', text: '#fff', label: 'KELİME<br>AVI', cols: 4, cells: ['K', 'E', 'D', 'İ', 'A', 'R', 'U', 'T'], tones: ['y', 'y', 'y', 'y', '', '', '', ''] }, category: 'word', search: 'harf bulmaca kelime avı' },
  { id: 'tetris', tagline: 'Blokları diz', href: 'games/tetris/', title: 'Tetris', cover: { name: 'tetris', color: '#5b2bb5', text: '#fff', label: 'TETRİS', cols: 4, cells: ['', '', '', '', '', '', '', '', '', '', '', ''], tones: ['n', 'p', 'n', 'c', 'p', 'p', 'p', 'c', 'o', 'r', 'r', 'c'] }, category: 'classic logic', search: 'blok satır' },
  { id: 'soliter', tagline: 'Kartları sırala', href: 'games/soliter/', title: 'Soliter', cover: { name: 'soliter', color: '#0f7a55', text: '#fff', label: 'SOLİTER', cells: ['A♥', 'K♠', 'Q♦'], tones: ['h', 'w', 'h'] }, category: 'classic', search: 'solitaire kart klondike iskambil', size: 'wide' },
  { id: 'mahjong', tagline: 'Eş taşları bul', href: 'games/mahjong/', title: 'Mahjong', cover: { name: 'mahjong', color: '#d94f3d', text: '#fff', label: 'MAHJONG', cells: ['中', '發', '東', '東', '中', '發'], tones: ['h', 'j', 'w', 'w', 'h', 'j'] }, category: 'classic logic', search: 'taş eşleştir mahjong solitaire' },
  { id: 'araba', tagline: 'Engellerden kaç', href: 'games/araba/', title: 'Araba Yarışı', cover: { name: 'araba', color: '#3d4250', text: '#fff', label: 'ARABA<br>YARIŞI', cells: ['', '', '', '', '', '', '', '', ''], tones: ['y', 'n', 'n', 'n', 'n', 'b', 'n', 'r', 'n'] }, category: 'classic', search: 'yarış araba trafik' }
];
