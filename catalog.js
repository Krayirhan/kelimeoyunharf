...
window.OYUN_ARASI_GAMES = [
  ...
  { id: 'soliter', tagline: 'Kartları sırala', href: 'games/soliter/', title: 'Soliter', image: 'assets/covers/soliter.webp', cover: { name: 'soliter', color: '#0f7a55', text: '#fff', label: 'SOLİTER', cells: ['A♥', 'K♠', 'Q♦'], tones: ['h', 'w', 'h'] }, category: 'classic', search: 'solitaire kart klondike iskambil', size: 'wide' },
