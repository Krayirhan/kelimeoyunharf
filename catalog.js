...
window.OYUN_ARASI_GAMES = [
  ...
  { id: 'tetris', tagline: 'Blokları diz', href: 'games/tetris/', title: 'Blok Düşür', cover: { name: 'tetris', color: '#5b2bb5', text: '#fff', label: 'BLOK<br>DÜŞÜR', cols: 4, cells: ['', '', '', '', '', '', '', '', '', '', '', ''], tones: ['n', 'p', 'n', 'c', 'p', 'p', 'p', 'c', 'o', 'r', 'r', 'c'] }, category: 'classic logic', search: 'blok düşür satır tetris' },
